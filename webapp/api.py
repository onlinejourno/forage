"""Prowl — JSON API over the existing public-data analysis.
...
app = FastAPI(title="Prowl API", version="1.0.0")
...
def _briefing(url: str, main: dict, ranks: dict) -> str:
    ...
    lines += [
        ...
        "",
        "*Generated by OnlineJourno Prowl — data from public sources (sitemap, robots.txt, Common Crawl).*",
    ]
    return "\n".join(lines)
